...
in_file_tcpSynack=$folder_prefix"http/out_tcp/out_srcIP_synack.set"
tmp=$folder_prefix"tmp.set"

out_file=$folder_prefix"http/out_tcp/out_srcIP_rst.set"
log_file=$folder_prefix"http/out_tcp/log_out_srcIP_rst_set.log"
