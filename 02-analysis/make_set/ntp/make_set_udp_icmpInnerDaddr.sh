...
in_file_ntpSuccess=$folder_prefix"ntp/out_udp/out_srcIP_ntp_success.set"
tmp=$folder_prefix"tmp.set"

out_file_unreach=$folder_prefix"ntp/out_udp/out_innerdaddr_icmpUnreach.set"
out_file_timxceed=$folder_prefix"ntp/out_udp/out_innerdaddr_icmpTimxceed.set"
out_file_redirect=$folder_prefix"ntp/out_udp/out_innerdaddr_icmpRedirect.set"
out_file_srcquench=$folder_prefix"ntp/out_udp/out_innerdaddr_icmpSrcquench.set"
out_file_all=$folder_prefix"ntp/out_udp/out_innerdaddr.set"

log_file=$folder_prefix"ntp/out_udp/log_out_srcIP_udp53IcmpInnerdaddr_set.log"
