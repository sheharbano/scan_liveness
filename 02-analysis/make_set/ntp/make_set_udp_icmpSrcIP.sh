...
folder_prefix="/home/bano/my_media/nemesis/vertical/"$scan_folder"/ntp/"

in_file=$folder_prefix"proc/flat/ntp.flat"

in_file_ntpSuccess=$folder_prefix"out_udp/out_srcIP_ntp_success.set"
