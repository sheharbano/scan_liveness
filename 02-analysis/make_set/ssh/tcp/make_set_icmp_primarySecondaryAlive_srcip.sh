#source "/home/bano/scripts/make_set/ssh/tcp/config_scan_folder.sh"
folder_prefix="/home/bano/my_media/nemesis/vertical/"$scan_folder"/"

in_file=$folder_prefix"ssh/out_tcp/out.log"

out_file_primary=$folder_prefix"ssh/out_tcp/out_srcIP_icmp_primaryAlive.set"
out_file_secondary=$folder_prefix"ssh/out_tcp/out_srcIP_icmp_secondaryAlive.set"
log_file=$folder_prefix"ssh/out_tcp/log_out_srcIP_icmpPrimarySecondaryAlive_set.log"
