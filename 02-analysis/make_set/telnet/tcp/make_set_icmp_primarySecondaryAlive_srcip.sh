...
out_file_primary=$folder_prefix"telnet/out_tcp/out_srcIP_icmp_primaryAlive.set"
out_file_secondary=$folder_prefix"telnet/out_tcp/out_srcIP_icmp_secondaryAlive.set"
log_file=$folder_prefix"telnet/out_tcp/log_out_srcIP_icmpPrimarySecondaryAlive_set.log"
