...
#FIXME
file_prefix='/home/bano/my_media/nemesis/vertical/07-09-2017/icmp/second/'
...
fOut.write("ZMAP (ICMP) second\n")

blocks=["block1","block2","block3","block4","block5","block6","block7"]

# ======== ZMAP (ICMP) second =========
for block in blocks:
	file_icmp2=file_prefix+block+'/meta.log'
	with open(file_icmp2) as data_file:
